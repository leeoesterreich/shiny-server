...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      p("Data from Marcotte et al 2016 (https://www.ncbi.nlm.nih.gov/pubmed/26771497). Per gene log2 FPKM was Quantile-Normalized, and a floor value set at log2(0.1) FPKM.Per gene zGARP score was served as gene essentiality scores. 3 ER+ILC cells lines MDAMB134, MDAMB330, SUM44 are in the dataset"),
